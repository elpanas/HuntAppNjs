...
async function generateQrPdf(idg) {  
    ...
    locations.forEach(loc => {
        ...
        htmlToPdf(tmppdf + loc._id + 'page1');
        ...
        htmlToPdf(tmppdf + loc._id + 'page2');
    })

}

function htmlToPdf(filepath) {
    const html = fs.readFileSync(filepath + '.html', 'utf8'),
        options = { format: 'A4', orientation: 'Portrait' };
    
    pdf.create(html, options).toFile(filepath + '.pdf', function(err, res) {
